...
internal interface SearchInteractor {
    ...
    suspend fun getSportActivityList(filterData: SearchDestination.SearchFilterData = SearchDestination.SearchFilterData()): ResultWrapper<SearchListSportActivityModel, MotsiError>
